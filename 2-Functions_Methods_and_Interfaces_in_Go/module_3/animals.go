...
func request() (string, string) {
	...
	fmt.Println("Input name of the animal and information that you want to know about it:")
	fmt.Scan(&animal, &information)
	return animal, information
}

func reply(animal, info string) {
	switch animal {
	case "cow":
		switch info {
		case "eat":
	...
	default:
		fmt.Printf("I don't know animal %s\n", animal)
		return
	}
}
